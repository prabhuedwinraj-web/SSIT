...
export const GROUPS = [
  ...
  },
  {
    ...
    items: [
      { label: 'HCI, Private Cloud & Virtualisation', to: '/digital-infrastructure/hci-private-cloud', icon: faCloud },
...
export const ROUTE_FOR = (() => {
  ...
  Object.assign(m, {
    ...
    'HCI & Private Cloud': '/digital-infrastructure/hci-private-cloud',
    'Virtualisation': '/digital-infrastructure/hci-private-cloud',
